...
00000100 <ls>:
{
 ...
 142:	66 83 f8 02          	cmp    $0x2,%ax
 146:	74 48                	je     190 <ls+0x90>
 148:	66 83 f8 03          	cmp    $0x3,%ax
 14c:	0f 84 7e 00 00 00    	je     1d0 <ls+0xd0>
 152:	66 83 f8 01          	cmp    $0x1,%ax
 156:	74 78                	je     1d0 <ls+0xd0>
  close(fd);
 158:	83 ec 0c             	sub    $0xc,%esp
 15b:	53                   	push   %ebx
 15c:	e8 49 04 00 00       	call   5aa <close>
 ...
 1f8:	e9 5b ff ff ff       	jmp    158 <ls+0x58>
 ...
 278:	0f 85 da fe ff ff    	jne    158 <ls+0x58>
      if(de.inum == 0)
